...
.leading-\\[1\\.5\\]{line-height:1.5;};
  ...
  const translateIcon = b`<svg viewBox="0 0 24 24" width="20" height="20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 8l6 6"/><path d="M4 14l6-6 2-3"/><path d="M2 5h12"/><path d="M7 2h1"/><path d="M14 22l2.5-5L19 22"/><path d="M12 17h8"/></svg>`;
  const LANGUAGES = [
{ label: "EN", value: "en" },
...
.font-600{font-weight:600;};
  ...
  CtSectionHeader = __decorateClass$5([
    t("ct-section-header")
  ], CtSectionHeader);
...
.transition-duration-0\\.3s{transition-duration:0.3s;};
  ...
  ChromeTranslateSettings = __decorateClass$3([
...
.ease{transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);};
  ...
  ChromeTranslateBall = __decorateClass$2([
  ...
  ChromeTranslateSelection = __decorateClass$1([
  ...
  let ChromeTranslatePanel = class extends i {
    constructor() {
      super(...arguments);
      this.open = false;
      this.inputText = "";
      ...
      this.onKeydown = (e2) => {
        if (e2.key === "Escape" && this.open) {
          this.closePanel();
        }
        if ((e2.ctrlKey || e2.metaKey) && e2.key === "Enter" && this.open) {
          this.onTranslate();
        }
      };
    }
    ...
    syncConfig() {
      _GM_setValue(STORAGE_CONFIG_KEY, {
        ..._GM_getValue(STORAGE_CONFIG_KEY, {}),
        language: this.language
      });
    ...
    onLanguageFromChange(e2) {
      this.language = { ...this.language, from: e2.detail.value };
      this.syncConfig();
    }
    onLanguageToChange(e2) {
      this.language = { ...this.language, to: e2.detail.value };
      this.syncConfig();
    }
    onInputChange(e2) {
      this.inputText = e2.detail.value;
    }
    async onTranslate() {
      ...
      try {
        ...
        this.error = e2.message || "Translation failed";
      } finally {
        this.loading = false;
      }
    }
        ...
        <div class="ct-panel-body">
          ...
          <div class="ct-panel-actions">
            <button
              ...
              @click=${this.onTranslate}
            >
              ${this.loading ? x`<span class="ct-panel-spinner"></span> Translating...` : "Translate"}
            </button>
            <button class="ct-panel-btn ct-panel-btn-secondary" @click=${this.onClear}>Clear</button>
          </div>

          <!-- Error -->
          ${this.error ? x`<div class="ct-panel-error">${this.error}</div>` : E}
  ...
  ChromeTranslatePanel.styles = i$3`
    :host {
      all: initial;
      display: contents;
    }
  ...
  __decorateClass([
    r()
  ], ChromeTranslatePanel.prototype, "open", 2);
  __decorateClass([
    r()
  ], ChromeTranslatePanel.prototype, "inputText", 2);
  __decorateClass([
    r()
  ], ChromeTranslatePanel.prototype, "outputText", 2);
  __decorateClass([
    r()
  ], ChromeTranslatePanel.prototype, "loading", 2);
  __decorateClass([
    r()
  ], ChromeTranslatePanel.prototype, "error", 2);
  __decorateClass([
    r()
  ], ChromeTranslatePanel.prototype, "language", 2);
  ChromeTranslatePanel = __decorateClass([
    t("chrome-translate-panel")
  ], ChromeTranslatePanel);
